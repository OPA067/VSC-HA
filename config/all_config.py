...
class AllConfig(Config):
    ...
    def parse_args(self):
        ...
        ''' we choose center # K = [4, 8, 12, 16, 32]'''
        parser.add_argument('--center', type=int, default=8, help='K factor numbers')
        parser.add_argument('--alpha', type=float, default=1e-3, help='video-sentence loss weight')
        parser.add_argument('--beta', type=float, default=1e-1, help='entity-word loss weight')
